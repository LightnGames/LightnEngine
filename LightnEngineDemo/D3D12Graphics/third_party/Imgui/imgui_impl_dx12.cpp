...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    // Create the root signature
    {
        ...
        // point sampler
        {
            D3D12_STATIC_SAMPLER_DESC& sampler = staticSamplers[1];
            sampler = staticSamplers[0];
    ...
    // Create the vertex shader
    {
     ...
     //   D3DCompile(vertexShader, strlen(vertexShader), NULL, NULL, NULL, "main", "vs_6_0", 0, 0, &g_pVertexShaderBlob, &error);
     ...
     //       return false;
     //   }
        D3DReadFileToBlob(L"L:/LightnEngine/resource/common/shader/debug/imgui.vso", &g_pVertexShaderBlob);
        ...
        static D3D12_INPUT_ELEMENT_DESC local_layout[] = {
			...
			{ "CHANNEL",    0, DXGI_FORMAT_R32_UINT,       0, (UINT)IM_OFFSETOF(ImDrawVert, channel),       D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
            { "COLORRANGE", 0, DXGI_FORMAT_R32G32_FLOAT,   0, (UINT)IM_OFFSETOF(ImDrawVert, color_range),   D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
            { "SAMPLER",    0, DXGI_FORMAT_R32_UINT,       0, (UINT)IM_OFFSETOF(ImDrawVert, sampler_index), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
        };
        psoDesc.InputLayout = { local_layout, 6 };
    }
    ...
    // Create the pixel shader
    {
     ...
     //         uint sampler_index = input.sampler_index;\
			  //float4 tex_col = texture0.Sample(samplers[sampler_index], input.uv);\
     ...
     //       }";
        ...
        //ID3DBlob* error = nullptr;
        //D3DCompile(pixelShader, strlen(pixelShader), NULL, NULL, NULL, "main", "ps_6_0", 0, 0, &g_pPixelShaderBlob, &error);
        ...
        //    return false;
        //}
        D3DReadFileToBlob(L"L:/LightnEngine/resource/common/shader/debug/imgui.pso", &g_pPixelShaderBlob);
