...
//-----------------------------------------------------------------------------
enum ImColorChannelFilter {
	ImColorChannelFilter_Default = 0,
	ImColorChannelFilter_R,
	ImColorChannelFilter_G,
	ImColorChannelFilter_B,
	ImColorChannelFilter_RGB,
    ImColorChannelFilter_LINER_DEPTH,
	ImColorChannelFilter_Count
};

enum ImTextureSmplerType {
    ImTextureSamplerType_Liner = 0,
    ImTextureSamplerType_Point,
    ImTextureSamplerType_Count
};
...
namespace ImGui
{
    ...
    IMGUI_API void          Image(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0), ImColorChannelFilter channel = ImColorChannelFilter_Default, const ImVec2& color_range = ImVec2(0, 1), ImTextureSmplerType sampler_type = ImTextureSamplerType_Liner);
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddImage(ImTextureID user_texture_id, const ImVec2& p_min, const ImVec2& p_max, const ImVec2& uv_min = ImVec2(0, 0), const ImVec2& uv_max = ImVec2(1, 1), ImU32 col = IM_COL32_WHITE, ImColorChannelFilter channel = ImColorChannelFilter_Default, const ImVec2& color_range = ImVec2(0, 1), ImTextureSmplerType sampler_type = ImTextureSamplerType_Liner);
    ...
    IMGUI_API void  PrimRectUV(const ImVec2& a, const ImVec2& b, const ImVec2& uv_a, const ImVec2& uv_b, ImU32 col, ImColorChannelFilter channel, const ImVec2& color_range, ImTextureSmplerType sampler_type);
